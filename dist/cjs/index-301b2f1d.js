...
const NAMESPACE = 'stencil-docs-not-working';
    ...
    if (module) {
        ...
        if (!hmrVersionId || !BUILD.hotModuleReplacement) {
          ...
          switch(bundleId) {
                ...
                case 'test-component.cjs':
                    return Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require(
                        /* webpackMode: "lazy" */
                        './test-component.cjs.entry.js')); }).then(processMod, consoleError);
          }
      }
    return Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require(
    /* @vite-ignore */
...
//# sourceMappingURL=index-301b2f1d.js.map